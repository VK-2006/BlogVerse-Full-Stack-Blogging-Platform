import { BookOpen, LogOut, Menu, Moon, PenLine, Search, Settings, ShieldCheck, Sun, UserRound, Users, X } from "lucide-react";
  ...
  return (
    <header className="nav-shell">
      ...
      <div className="container nav-inner">
        ...
        {open && <button className="nav-backdrop" aria-label="Close navigation" onClick={closeMenu} />}
        ...
        <div className="nav-actions">
          ...
          {user ? (
            <>
              {user.role === "ADMIN" && <Link className="icon-button desktop-profile-button" to="/admin" title="Admin control center"><ShieldCheck size={18} /></Link>}
              ...
              <button className="icon-button" onClick={signOut} title="Logout"><LogOut size={18} /></button>
            </>
          ) : (
            <>
